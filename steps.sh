...
##
## ``` sh
## sudo IS_DEBUG=true ./skel.sh mate
## ```
##
## run
##
## ``` sh
## sudo REF_MAIN_RUN=test IS_DEBUG=true ./skel.sh mate
## ```
##
...
model_var_init () {
	...
	REF_ISO_PROFILE_REPO_GIT_URL="https://github.com/samwhelp/ezarcher-live-build-config-template-mate.git"

	#REF_ISO_PROFILE_REPO_ARCHIVE_URL="https://github.com/samwhelp/ezarcher-live-build-config-template-mate/archive/refs/heads/main.zip"
	REF_ISO_PROFILE_REPO_ARCHIVE_URL="https://github.com/samwhelp/ezarcher-live-build-config-template-mate/archive/refs/heads/main.tar.gz"


	REF_ISO_PROFILE_REPO_ARCHIVE_FILE_NAME="main.tar.gz"
	REF_ISO_PROFILE_REPO_ARCHIVE_EXTRACT_DIR_NAME="ezarcher-live-build-config-template-mate-main"
...
msg_usage_body_locale () {
	...
	util_error_echo
	util_error_echo "Example  : sudo REF_BUILD_LOCALE=zh_tw ./${REF_CMD_FILE_NAME} mate"
	util_error_echo
...
msg_usage_body_arch () {
	...
	util_error_echo
	util_error_echo "Example  : sudo REF_BUILD_ARCH=amd64 ./${REF_CMD_FILE_NAME} mate"
	util_error_echo
